  ...
  return (
    <div className="bg-background">
      ...
      <Card className="bg-card border-emerald-900/20 hover:border-emerald-800/40 transition-all duration-300">
        <CardHeader>
          <CardTitle className="text-xl font-semibold text-white">Basic Plan</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground mb-4">
            Good for quick consults and minor appointments
          </p>
          <p className="text-2xl font-bold text-white mb-4">$10 / month</p>
            <ul className="space-y-2 text-muted-foreground text-sm">
              <li>✔ Access to general doctors</li>
              <li>✔ 1 video consultation per month</li>
          </ul>
        </CardContent>
      </Card>
      ...
      <Card className="bg-card border-emerald-900/20 hover:border-emerald-800/40 transition-all duration-300">
        <CardHeader>
          <CardTitle className="text-xl font-semibold text-white">Standard Plan</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground mb-4">
            Ideal for regular check-ups and multiple consultations
          </p>
          <p className="text-2xl font-bold text-white mb-4">$25 / month</p>
            <ul className="space-y-2 text-muted-foreground text-sm">
              <li>✔ Access to all doctors</li>
              <li>✔ 5 video consultations per month</li>
      ...
      <Card className="bg-card border-emerald-900/20 hover:border-emerald-800/40 transition-all duration-300">
        <CardHeader>
          <CardTitle className="text-xl font-semibold text-white">Premium Plan</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground mb-4">
            Best for unlimited consultations and premium support
          </p>
          <p className="text-2xl font-bold text-white mb-4">$50 / month</p>
            <ul className="space-y-2 text-muted-foreground text-sm">
